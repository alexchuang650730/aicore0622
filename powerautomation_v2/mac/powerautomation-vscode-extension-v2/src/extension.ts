...
export function activate(context: vscode.ExtensionContext) {
    ...
    powerAutomationManager = new PowerAutomationManager(traeManager, logManager);
...
function openDashboard() {
    ...
    const dashboardPath = vscode.Uri.file(
        require('path').join(__dirname, '..', '..', 'ui', 'powerautomation_dashboard.html')
    );
...
class PowerAutomationViewProvider implements vscode.TreeDataProvider<PowerAutomationItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<PowerAutomationItem | undefined | null | void> = new vscode.EventEmitter<PowerAutomationItem | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<PowerAutomationItem | undefined | null | void> = this._onDidChangeTreeData.event;
    ...
    getTreeItem(element: PowerAutomationItem): vscode.TreeItem {
        return element;
    }

    getChildren(element?: PowerAutomationItem): Thenable<PowerAutomationItem[]> {
        if (!element) {
            // 根節點
