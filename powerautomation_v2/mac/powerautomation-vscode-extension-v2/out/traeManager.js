...
class TraeManager {
    constructor(logManager) {
        this.traePath = '/usr/local/bin/trae';
        this.sendCommand = "echo '{message}' | trae -";
        this.syncCommand = 'trae sync';
     ...
     * 智能回覆生成
     */
    async generateIntelligentReply(conversation) {
        // 基於對話內容生成智能回覆
...
exports.TraeManager = TraeManager;
//# sourceMappingURL=traeManager.js.map